...
SOCKET_PATH = os.environ.get(
    "FLIPPER_BRIDGE_SOCKET", "/tmp/codex-flipper-bridge.sock"
)

# Host identity reported to the Flipper header label (claude/codex/cursor)
HOST_TYPE = os.environ.get("FLIPPER_HOST_TYPE", "codex")
...
# Persistent bridge state used by the Codex command wrappers.
_state_dir = _plugin_data or os.path.join(tempfile.gettempdir(), "flipper-codex-buddy")
...
# Project root for scanning Codex skills and custom commands.
