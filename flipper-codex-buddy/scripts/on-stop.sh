...
# Stop hook: notify Flipper when Codex finishes a turn, with tool usage summary.

SOCKET="/tmp/codex-flipper-bridge.sock"
STATS="/tmp/codex-flipper-turn-stats.json"
...
SKIP_FLAG="/tmp/codex-flipper-skip-stop.flag"
if [ -f "$SKIP_FLAG" ]; then
